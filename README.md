...
├── css/             # Modular CSS enforcing the design system
├── data/            # Local data resources and JSON files
├── js/              # Frontend application logic
│   ├── ai/          # AI Hub controllers and views
│   ├── auth/        # Authentication flows and modals
│   ├── core/        # SPA bootstrapper and routing engine
│   ├── dashboard/   # Dashboard and landing page logic
│   ├── docs/        # Documentation search controllers
│   ├── git/         # GitHub 3D Explorer and API logic
│   ├── tools/       # Developer utilities and packages logic
│   ├── ui/          # Reusable UI components (Navbar, Loader)
│   ├── utils/       # Global helpers and shared logic
│   └── workspace/   # IDE and Code Snippet management
├── public/          # Static assets (Favicon, Icons, Manifest)
├── scripts/         # Shell/Node scripts for testing and setup
├── server/          # Node.js Express backend entry points
