    ...
    render() {
        ...
        content.innerHTML = `
            <style>
                ...
                .tcard-icon i { background-clip: text; -webkit-background-clip: text; -webkit-text-fill-color: transparent; }
                .ic-gold { background: rgba(234,179,8,0.12); border: 1px solid rgba(234,179,8,0.2); }
                .ic-gold i { background-image: linear-gradient(135deg, #fef08a, #eab308); }
                .ic-blue { background: rgba(59,130,246,0.12); border: 1px solid rgba(59,130,246,0.2); }
                .ic-blue i { background-image: linear-gradient(135deg, #93c5fd, #3b82f6); }
                .ic-green { background: rgba(34,197,94,0.12); border: 1px solid rgba(34,197,94,0.2); }
                .ic-green i { background-image: linear-gradient(135deg, #86efac, #22c55e); }
                .ic-cyan { background: rgba(6,182,212,0.12); border: 1px solid rgba(6,182,212,0.2); }
                .ic-cyan i { background-image: linear-gradient(135deg, #67e8f9, #06b6d4); }
                .ic-purple { background: rgba(168,85,247,0.12); border: 1px solid rgba(168,85,247,0.2); }
                .ic-purple i { background-image: linear-gradient(135deg, #d8b4fe, #a855f7); }
                .ic-pink { background: rgba(236,72,153,0.12); border: 1px solid rgba(236,72,153,0.2); }
                .ic-pink i { background-image: linear-gradient(135deg, #f9a8d4, #ec4899); }
            ...
            <div class="page-enter">
                ...
                <div class="dash-hero">
                    <div class="hero-main" data-page="ask-ai">
                        ...
                        <span class="btn btn-primary btn-sm" style="pointer-events:none;"><i class="fa-solid fa-arrow-right"></i> Open AI Hub</span>
