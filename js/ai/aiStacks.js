const AiStacksMixin = {
  roleData: {
    web: {
      ...
      desc: "Everything you need to go from idea to deployed website.",
      stack: [
        {
          name: "HTML/CSS/JS",
          type: "Foundation",
          desc: "Core web technologies — start here",
        ...
        },
        {
          name: "React / Vue",
          type: "Framework",
          desc: "Build dynamic, component-based UIs",
        ...
        },
        {
          name: "Vercel / Netlify",
          type: "Hosting",
          desc: "Deploy instantly with git push",
        ...
        },
        {
          name: "REST APIs",
          type: "Data",
          desc: "Fetch data from external services",
        ...
        },
        {
          name: "GitHub Pages",
          type: "Free Hosting",
          desc: "Host static sites directly from your repo",
    ...
    mobile: {
      ...
      desc: "Create cross-platform mobile applications for iOS and Android.",
      stack: [
        {
          name: "React Native",
          type: "Framework",
          desc: "Build native apps with React and JS",
          icon: "fa-brands fa-react",
          color: "#61dafb",
        },
        {
          name: "Expo",
          type: "Toolchain",
          desc: "Fastest way to build React Native apps",
        ...
        },
        {
          name: "Flutter",
          type: "Framework",
          desc: "Google UI toolkit for mobile, web, desktop",
        ...
        },
        {
          name: "Firebase",
          type: "Backend",
          desc: "Auth, database, storage, hosting",
        ...
        },
        {
          name: "AsyncStorage",
          type: "Storage",
          desc: "Simple key-value local storage",
        ...
        },
        {
          ...
          type: "Distribution",
          desc: "Publish to millions of users",
    ...
    ai: {
      title: "Learn AI / ML",
      desc: "Get started with artificial intelligence — from APIs to training models.",
      stack: [
        {
          name: "OpenAI API",
          type: "AI API",
          desc: "GPT models for text generation",
        ...
        },
        {
          name: "TensorFlow.js",
          type: "ML Library",
          desc: "Run ML models in the browser",
        ...
        },
        {
          name: "Hugging Face",
          type: "Models Hub",
          desc: "Thousands of pre-trained models",
        ...
        },
        {
          name: "Python + Jupyter",
          type: "Environment",
          desc: "Standard toolkit for data science",
        ...
        },
        {
          name: "Kaggle",
          type: "Datasets",
          desc: "Free datasets and competitions",
        ...
        },
        {
          name: "Replicate",
          type: "Inference",
          desc: "Run ML models via API calls",
    ...
    backend: {
      ...
      desc: "Learn server-side applications, REST APIs, and databases.",
      stack: [
        {
          name: "Node.js",
          type: "Runtime",
        ...
        },
        {
          name: "Express.js",
          type: "Framework",
          desc: "Minimal web framework for Node",
        ...
        },
        {
          name: "MongoDB",
          type: "Database",
          desc: "Flexible NoSQL document DB",
    ...
    devops: {
      ...
      desc: "Automate deployments, containerize apps, and manage infrastructure.",
      stack: [
        {
          name: "Docker",
          type: "Containers",
          desc: "Package apps into containers",
        ...
        },
        {
          name: "GitHub Actions",
          type: "CI/CD",
          desc: "Automate build/test/deploy",
          icon: "fa-brands fa-github",
          color: "#e8e4dc",
        },
        {
        ...
        },
        {
          name: "Linux / Bash",
          type: "OS",
          desc: "Server administration skills",
