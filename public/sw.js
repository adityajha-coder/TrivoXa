...
const STATIC_ASSETS = [
    ...
    '/js/pages/main/workspace.js?v=9',
    '/js/pages/main/docs.js?v=12',
    '/js/pages/tools/toolsVault.js?v=7',
    '/js/pages/tools/commands.js?v=6',
    '/js/pages/tools/freeApis.js?v=14',
    '/js/pages/tools/packageScout.js?v=7',
